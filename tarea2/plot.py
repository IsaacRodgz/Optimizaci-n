...
def plot_level_set(xs, f, x_left, x_right, y_left, y_right, init_point, min_point):
    ...
    plt.plot([min_point[0]], [min_point[1]],
             marker="^", markersize=7, c='yellow')

    # Plot initial point with orange circle
    plt.plot([init_point[0]], [init_point[1]],
             marker="o", markersize=6, c='tab:orange')
