...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--step', default="cubic", type=str, help='Gradient step size method to use: cubic, barzilai')
    ...
    run(args.step, args.point, args.method, args.function)
